...
- [VPS migration 9/22](project_vps_migration_sep22.md) — cutover to new 6-core/11GB host; portfolio_sync bug root-caused+fixed+live-verified (contingent-order netting); Danelfin confirmed fully inactive; sleeved-mode (:8001) reconciliation still broken, worsened by a forced test (7 new pending orders)
